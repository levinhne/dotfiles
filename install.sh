...
# Utilities
sudo pacman -S --noconfirm picom lxappearance ly rofi jq wget htop maim xclip ripgrep fzf eza bat zoxide feh dunst gzip zip unzip p7zip unrar unarchiver xarchiver neofetch stow netutils openssh
